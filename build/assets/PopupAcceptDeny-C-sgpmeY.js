import{aB as M,r as p,aC as $,ac as z,j as e,ad as F,bJ as j,e as H,a as R,u as N,s as I,B as d,T as y,bK as O,R as S,bL as Y,bM as W,A as L,bN as q,E as J,p as v}from"./index-CTi-Fr8w.js";import{u as K}from"./useControlled-DiwwqgQs.js";import{h as U}from"./moment-G82_0lEo.js";import{A}from"./Avatar-l8tzGONk.js";import{f as X,a as G,r as Q}from"./invite-DVA553hs.js";function Z(n){const{checked:a,defaultChecked:t,disabled:c,onBlur:l,onChange:s,onFocus:i,onFocusVisible:x,readOnly:f,required:g}=n,[u,k]=K({controlled:a,default:!!t,name:"Switch",state:"checked"}),T=r=>o=>{var h;o.nativeEvent.defaultPrevented||(k(o.target.checked),s==null||s(o),(h=r.onChange)==null||h.call(r,o))},{isFocusVisibleRef:b,onBlur:D,onFocus:V,ref:P}=M(),[m,w]=p.useState(!1);c&&m&&w(!1),p.useEffect(()=>{b.current=m},[m,b]);const C=p.useRef(null),_=r=>o=>{var h;C.current||(C.current=o.currentTarget),V(o),b.current===!0&&(w(!0),x==null||x(o)),i==null||i(o),(h=r.onFocus)==null||h.call(r,o)},E=r=>o=>{var h;D(o),b.current===!1&&w(!1),l==null||l(o),(h=r.onBlur)==null||h.call(r,o)},B=$(P,C);return{checked:u,disabled:!!c,focusVisible:m,getInputProps:(r={})=>z({checked:a,defaultChecked:t,disabled:c,readOnly:f,ref:B,required:g,type:"checkbox",role:"switch","aria-checked":a},r,{onChange:T(r),onFocus:_(r),onBlur:E(r)}),inputRef:B,readOnly:!!f}}const ee=j("span")`
